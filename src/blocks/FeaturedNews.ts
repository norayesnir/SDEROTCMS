...
const FeaturedNews: Block = {
  slug: 'featuredNewsBlock',
  labels: {
    singular: {
      en: 'Featured News Block',
      nl: 'Uitgelicht Nieuws Blok',
    },
    plural: {
      en: 'Featured News Blocks',
      nl: 'Uitgelicht Nieuws Blokken',
    },
  },
  interfaceName: 'FeaturedNewsBlock',
